    ...
    <main id="cart">
        <div class="container">
            <nav class="mt-2 mb-2" style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a class="text-decoration-none" href="shop.html">Shop</a></li>
                    ...
                    <table class="table table-borderless text-center table-cart">
                        ...
                        <tbody>
                          <tr>
                            <td>
                                <div class="position-relative">
                                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSdq0BfB70WI3UM5iFrRWAfPCcI_xfgJidpUbxk-iKTOYhOsfsmgYCRG9XGXgJfKp5e218&usqp=CAU"  class="p-2" height="100px" width="100px" alt="">
                                    <div class="btn-del top-0 start-0">x</div>
                                </div>
                            </td>
                            <td>
                                <a href="product.html">ASUS X550CA</a>
                            </td>
                            <td>$250.00</td>
                            <td>
                          ...
                          <tr>
                            <td>
                                <div class="position-relative">
                                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQtnmDRih1E3G4hNyQoAlabjqJANhHvFOxCqA&usqp=CAU"  class="p-2" height="100px" width="100px" alt="">
                                    <div class="btn-del top-0 start-0">x</div>
                                </div>
                            </td>
                            <td>
                                <a href="product.html">Sony MDR-ZX310APB</a>
                            </td>
                            <td>$250.00</td>
                            <td>
                                <div class="product-cant">
